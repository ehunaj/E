...
const myBot = ['ub3808de9f7df35f57fb366d157f9790a'];
const banList = [];//Banned list
var groupList = new Array();//Group list
var vx = {};var midnornama,pesane,kickhim;var waitMsg = "no";//DO NOT CHANGE THIS
const imgArr = ['png','jpg','jpeg','gif','bmp','webp'];//DO NOT CHANGE THIS
var komenTL = "AutoLike by Bot\nline://ti/p/~sarehun"; //Comment for timeline
var bcText = "Salken all";
...
\n\n# https://line.me/ti/p/~sarehun  ^_^";
    ...
    poll(operation) {
		...
		if(operation.type == 5 && this.stateStatus.salam == 1) {//someone adding me..
            let halo = new Message();
			halo.to = operation.param1;
			halo.text = "Creator: https://line.me/ti/p/~sarehun ";
			this._client.sendMessage(0, halo);
        }
...
\n";
        ...
        if(txt == '!halo') {
            ...
            this._sendMessage(seq, 'Hai'+displayName);
        }
        ...
        if(txt === '!salken' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            ...
            for (var i = 0; i < listMember.length; i++) {
                if(!isAdminOrBot(listMember[i].mid)){
                    ...
                    this._cancelAll(seq.to,[listMember[i].mid])
                }
            }
        }else if(txt === '!salken' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
...
====================\n";
		...
		if(txt == "!kill" && isAdminOrBot(seq.from_)){
			for(var i = 0; i < banList.length; i++){
		...
		}else if(txt == "!kill" && !isAdminOrBot(seq.from_)){this._sendMessage(seq,"Not permitted !");}
